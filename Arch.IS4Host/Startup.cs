    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var builder = services.AddIdentityServer(options =>
            {
                ...
                //chage to database storing configurationData
                .AddConfigurationStore(configDb => {
                    configDb.ConfigureDbContext = db => db.UseSqlServer(conectionString,
                        sql => sql.MigrationsAssembly(migrationAssembly));
                })
                //Database for storing operation data
                .AddOperationalStore(operationalDb => {
                    operationalDb.ConfigureDbContext = db => db.UseSqlServer(conectionString,
                        sql => sql.MigrationsAssembly(migrationAssembly));
                })
